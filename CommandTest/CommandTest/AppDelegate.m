...
-(IBAction)executeCommand:(id)sender{
    ...
    // command create
    NSString *copyFromPath = @"~/Library/Application Support/Skype/katsuhide1982/";
    NSString *copyFromName = @"main.db";
    NSString *copyFromFile = [[copyFromPath stringByAppendingPathComponent:copyFromName] stringByExpandingTildeInPath];
    
    NSString *copyToPath = @"~/Library/Application Support/RecDesktop/";
...
// Returns the directory the application uses to store the Core Data store file. This code uses a directory named "katz.CommandTest" in the user's Application Support directory.
- (NSURL *)applicationFilesDirectory
{
    NSFileManager *fileManager = [NSFileManager defaultManager];
    NSURL *appSupportURL = [[fileManager URLsForDirectory:NSApplicationSupportDirectory inDomains:NSUserDomainMask] lastObject];
    return [appSupportURL URLByAppendingPathComponent:@"katz.CommandTest"];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CommandTest" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *url = [applicationFilesDirectory URLByAppendingPathComponent:@"CommandTest.storedata"];
